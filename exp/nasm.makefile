...
macos:
	rm -fr bld
	mkdir bld
	$(CC) -m64 $(CCOPTS) -c osint/*.c
	mv *.o bld
	./bin/sbl_macos -u macos -1=sbl.asm -2=bld/sbl.lex -3=bld/sbl.equ lex.sbl
#	./bin/sbl_macos -u macos:$(TRC) -1=bld/sbl.lex -2=bld/sbl.tmp -3=bld/sbl.err -4=bld/sbl.equ nasm/asm.sbl
	./bin/sbl_macos -u macos -1=bld/sbl.lex -2=bld/sbl.tmp -3=bld/sbl.err -4=bld/sbl.equ nasm/asm.sbl
	./bin/sbl_macos -u macos -1=bld/sbl.err -2=bld/err.s err.sbl
	cat nasm/sys.asm bld/err.s bld/sbl.tmp >bld/sbl.s
	nasm -f macho64 -o bld/sbl.o bld/sbl.s
	$(CC) -lm -m64 $(LDOPTS) bld/*.o -lm  -osbl 
...
#
	...
	rm -f tb*
	rm -f bld/*
	echo "start macos nasm  sanity test"
	cp	./bin/sbl_macos tbol
	gcc -m64 -c osint/*.c
	mv *.o bld
	./tbol -u macos -1=sbl.asm -2=bld/sbl.lex -3=bld/sbl.equ lex.sbl
	./tbol -u macos -1=bld/sbl.lex -2=bld/sbl.tmp -3=bld/sbl.err -4=bld/sbl.equ nasm/asm.sbl
