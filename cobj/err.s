; compressed spitbol error messages 12/31/69 14:43:50
;
...
;  154  "argument is missing a left paren"
	db	2
	db	24
	db	17
	db	"a left paren"
...
;  187  "inappropriate file specification for "
	db	25
	db	153
	db	"specification f"
	db	163
...
;  208  "second argument is not numeric"
	db	9
	db	157
	db	0
...
;  239  "argument has null variable name"
	db	141
	db	"variable "
	db	26
	db	0
...
;  241  "evaluated argument is negative or too large"
	db	12
	db	168
	db	0

;  242  "argument is not integer or expression"
	db	136
	db	15
	db	0

;  243  "argument is not a string or expression"
	db	4
	db	15
	db	0
...
;  246  "first argument is not suitable integer or string"
	db	7
	db	1
	db	"sui"
	db	195
...
;  254  "evaluated argument is not a string"
	db	12
	db	4
	db	0

;  255  "argument negative"
	db	2
	db	"negative"
	db	0
