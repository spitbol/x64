...
ospipe(struct ioblk *ioptr)
{
    ...
    /*
       /    Control comes here ONLY in parent process. Return the file
       descriptor /    to be used for communication with child process or -1 if
       error.
     */
    return parentfd;
}
