...
extern	int			compress ( unsigned char FAR *startadr, uword size );
...
extern	int			expand ( File_handle fd, unsigned char FAR *startadr, uword size );
...
extern	void *		nextef ( unsigned char FAR **bufp, int io );
...
extern	int			rdaout ( File_handle fd, unsigned char FAR *startadr, uword size );
extern	int			rdenv ( struct scblk *varname, struct scblk *result );
#ifndef readfar
extern	uword		readfar ( File_handle fd, void FAR *Buf, uword Cnt );
#endif
...
#ifndef writefar
extern	uword		writefar ( File_handle fd, void FAR *Buf, uword Cnt );
#endif
extern	int			wrtaout ( unsigned char FAR *startadr, uword size );
