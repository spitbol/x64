...
extern int appendext
Params ((char *path, char *ext, char *result, int force));
extern int arg2scb
Params ((int req, int argc, char *argv[], struct scblk * scptr, int maxs));
#if EXTFUN
extern union block *callef
Params ((struct efblk * efb, union block ** sp, word nargs));
#endif
...
Params ((struct ioblk * ioptr, FILEPOS offset, int whence));
...
extern word osread
Params ((word mode, word recsiz, struct ioblk * ioptr, struct scblk * scptr));
extern void oswait Params ((int pid));
extern word oswrite
Params ((word mode, word linesiz, word recsiz, struct ioblk * ioptr,
	 struct scblk * scptr));
...
Params ((File_handle fd, char *bufp, unsigned int size));
...
extern int sioarg
Params ((int ioflg, struct ioblk * ioptr, struct scblk * scptr));
extern File_handle spit_open
Params ((char *Name, Open_method Method, File_mode Mode, int Access));
