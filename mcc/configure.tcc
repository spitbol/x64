...
echo "  --with-libtcc            use /lib/libgcc_s.so.1 instead of libtcc1.a"
echo ""
...
echo "GCC_MAJOR=$tcc_major" >> config.mak
echo "#define GCC_MAJOR $tcc_major" >> $TMPH
