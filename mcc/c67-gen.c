/*
 *  TMS320C67xx code generator for MCC
 * 
...
<<<<<<< HEAD
// although mcc thinks it is passing parameters on the stack,
=======
// although mcc thinks it is passing parameters on the stack,
...
<<<<<<< HEAD
// these are regs that mcc doesn't really know about, 
=======
// these are regs that mcc doesn't really know about, 
>>>>>>> 9f46140d1dcf361b37e482fdbdbbbd5e783a9d03
...
{
    if (r == 0)			// normal mcc regs
	return 0x2;		// A2
    else if (r == 1)		// normal mcc regs
	return 3;		// A3
    else if (r == 2)		// normal mcc regs
	return 0;		// B0
    else if (r == 3)		// normal mcc regs
=======
// map MCC reg to C67 reg number
...
<<<<<<< HEAD
// mapping from mcc reg number to 
=======
// mapping from mcc reg number to 
>>>>>>> 9f46140d1dcf361b37e482fdbdbbbd5e783a9d03
...
int C67_map_regc(int r)
{
	...
	return 0x2;
    else if (r == C67_B2)	// normal mcc regs
=======
// mcc reg 2 ->B0 -> 1
// mcc reg 3 ->B1 -> 2
// mcc reg 0 -> A2 -> 5
...
=======
// map MCC reg to C67 reg side A or B
...
<<<<<<< HEAD
	// if it is mcc is referencing what it thinks is a parameter
=======
	// if it is mcc is referencing what it thinks is a parameter
>>>>>>> 9f46140d1dcf361b37e482fdbdbbbd5e783a9d03
...
<<<<<<< HEAD
	    // mcc thinks is on the stack but for C67 is
=======
	    // mcc thinks is on the stack but for C67 is
>>>>>>> 9f46140d1dcf361b37e482fdbdbbbd5e783a9d03
...
void gfunc_prolog(CType * func_type)
{
	...
	// we can translate where mcc thinks they
...
=======
	vtop->r = VT_CMP;	// tell MCC that result is in "flags" actually B2
>>>>>>> 9f46140d1dcf361b37e482fdbdbbbd5e783a9d03
    } else {
	if (op == '+') {
	    if ((ft & VT_BTYPE) == VT_DOUBLE) {
