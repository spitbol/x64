# Build unix version of spitbol using the nasm assembler:
...
# (check that the tbol* files are same for three iterations of regression test.)
debug?=0
DEBUG:=$(debug)
...
unix:
	...
	./bin/sbl_unix -u unix -1=bld/sbl.err -2=bld/err.s err.sbl
	cat nasm/sys.asm bld/err.s bld/sbl.tmp >bld/sbl.s
	nasm -f elf64 -o bld/sbl.o bld/sbl.s
	$(CC) -lm -m64 $(LDOPTS) -static  bld/*.o -lm  -osbl 
...
#
	...
	./tbol -u unix -1=bld/sbl.err -2=bld/err.s err.sbl
	cat nasm/sys.asm bld/err.s bld/sbl.tmp >bld/sbl.s
	nasm -f elf64 -o bld/sbl.o bld/sbl.s
